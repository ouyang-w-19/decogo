...
def generate_model(superstructure, load_case, load_cases_per_block, data_instance):
    # ==============================================================================
    # *** USER-INPUT *** :
    # --------------------
    superstructure = superstructure  # 'S4', 'S8', 'S12', 'S16'
    load_case = load_case       # 'L1', 'L2', 'L4', 'L6', 'L8', 'L12', 'L16', 'L24'
    load_cases_per_block = load_cases_per_block  # int, e.g. 6
    data_instance = data_instance     # 0, 1, ..., 9
    solver_name = 'scip'
    ...
    path = os.path.join(os.path.dirname(__file__), 'DESSLib_instances',
