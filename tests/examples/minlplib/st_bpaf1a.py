...
m.obj = Objective(expr=m.x1*m.x6 + 2*m.x1 + 3*m.x6 + m.x2*m.x7 - 4*m.x2 - m.x7 + m.x3*m.x8 + 8*m.x3 - 2*m.x8 + m.x4*m.x9
                        + 4*m.x4 - 4*m.x9 + m.x5*m.x10 + 9*m.x5 + 5*m.x10, sense=minimize)
