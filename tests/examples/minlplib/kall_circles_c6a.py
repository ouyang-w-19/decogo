...
m.x1 = Var(within=Reals,bounds=(0.49,23.2),initialize=0.49)
...
m.x15 = Var(within=Reals,bounds=(0.7,2.2),initialize=0.7)
...
m.c1 = Constraint(expr= - m.x1 + m.x18 == -6.25176938064369)
...
m.c17 = Constraint(expr=(m.x6 - m.x14)*(m.x6 - m.x14) + (m.x7 - m.x15)*(m.x7 - m.x15) >= 1.44)
...
m.c20 = Constraint(expr=(m.x8 - m.x14)*(m.x8 - m.x14) + (m.x9 - m.x15)*(m.x9 - m.x15) >= 1.44)

m.c21 = Constraint(expr=(m.x10 - m.x12)*(m.x10 - m.x12) + (m.x11 - m.x13)*(m.x11 - m.x13) >= 1)

m.c22 = Constraint(expr=(m.x10 - m.x14)*(m.x10 - m.x14) + (m.x11 - m.x15)*(m.x11 - m.x15) >= 1.44)

m.c23 = Constraint(expr=(m.x12 - m.x14)*(m.x12 - m.x14) + (m.x13 - m.x15)*(m.x13 - m.x15) >= 1.44)
...
m.c36 = Constraint(expr=   m.x14 - m.x16 <= -0.7)

m.c37 = Constraint(expr=   m.x15 - m.x17 <= -0.7)
