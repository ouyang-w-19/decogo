...
m.x134 = Var(within=Reals,bounds=(0,None),initialize=1.86251452376903)
m.x135 = Var(within=Reals,bounds=(0,None),initialize=2.04008937802859)
m.x136 = Var(within=Reals,bounds=(0,None),initialize=2.62560028150429)
m.x137 = Var(within=Reals,bounds=(0,None),initialize=1.42761013897069)
m.x138 = Var(within=Reals,bounds=(0,None),initialize=1.2620720008888)
m.x139 = Var(within=Reals,bounds=(0,None),initialize=2.31316166033414)
m.x140 = Var(within=Reals,bounds=(0,None),initialize=1.30709790321263)
m.x141 = Var(within=Reals,bounds=(0,None),initialize=0.216885598111212)
m.x142 = Var(within=Reals,bounds=(0,None),initialize=0.216885598111212)
m.x143 = Var(within=Reals,bounds=(0,None),initialize=0.216885598111212)
m.x144 = Var(within=Reals,bounds=(0,None),initialize=0.223687434188917)
m.x145 = Var(within=Reals,bounds=(0,None),initialize=0.223687434188917)
m.x146 = Var(within=Reals,bounds=(0,None),initialize=0.223687434188917)
m.x147 = Var(within=Reals,bounds=(0,None),initialize=0.241394534940745)
m.x148 = Var(within=Reals,bounds=(0,None),initialize=0.241394534940745)
m.x149 = Var(within=Reals,bounds=(0,None),initialize=0.241394534940745)
m.x150 = Var(within=Reals,bounds=(0,None),initialize=0.196024080919901)
m.x151 = Var(within=Reals,bounds=(0,None),initialize=0.196024080919901)
m.x152 = Var(within=Reals,bounds=(0,None),initialize=0.196024080919901)
m.x153 = Var(within=Reals,bounds=(0,None),initialize=0.185975807488726)
m.x154 = Var(within=Reals,bounds=(0,None),initialize=0.185975807488726)
m.x155 = Var(within=Reals,bounds=(0,None),initialize=0.185975807488726)
m.x156 = Var(within=Reals,bounds=(0,None),initialize=0.232724498779901)
m.x157 = Var(within=Reals,bounds=(0,None),initialize=0.232724498779901)
m.x158 = Var(within=Reals,bounds=(0,None),initialize=0.232724498779901)
m.x159 = Var(within=Reals,bounds=(0,None),initialize=0.188851673985818)
m.x160 = Var(within=Reals,bounds=(0,None),initialize=0.188851673985818)
m.x161 = Var(within=Reals,bounds=(0,None),initialize=0.188851673985818)
...
m.c53 = Constraint(expr=m.x141*m.b113 + m.x141*m.x134 - m.x134*m.b113 <= 0)

m.c54 = Constraint(expr=m.x142*m.b114 + m.x142*m.x134 - m.x134*m.b114 <= 0)

m.c55 = Constraint(expr=m.x143*m.b115 + m.x143*m.x134 - m.x134*m.b115 <= 0)

m.c56 = Constraint(expr=m.x144*m.b116 + m.x144*m.x135 - m.x135*m.b116 <= 0)

m.c57 = Constraint(expr=m.x145*m.b117 + m.x145*m.x135 - m.x135*m.b117 <= 0)

m.c58 = Constraint(expr=m.x146*m.b118 + m.x146*m.x135 - m.x135*m.b118 <= 0)

m.c59 = Constraint(expr=m.x147*m.b119 + m.x147*m.x136 - m.x136*m.b119 <= 0)

m.c60 = Constraint(expr=m.x148*m.b120 + m.x148*m.x136 - m.x136*m.b120 <= 0)

m.c61 = Constraint(expr=m.x149*m.b121 + m.x149*m.x136 - m.x136*m.b121 <= 0)

m.c62 = Constraint(expr=m.x150*m.b122 + m.x150*m.x137 - m.x137*m.b122 <= 0)

m.c63 = Constraint(expr=m.x151*m.b123 + m.x151*m.x137 - m.x137*m.b123 <= 0)

m.c64 = Constraint(expr=m.x152*m.b124 + m.x152*m.x137 - m.x137*m.b124 <= 0)

m.c65 = Constraint(expr=m.x153*m.b125 + m.x153*m.x138 - m.x138*m.b125 <= 0)

m.c66 = Constraint(expr=m.x154*m.b126 + m.x154*m.x138 - m.x138*m.b126 <= 0)

m.c67 = Constraint(expr=m.x155*m.b127 + m.x155*m.x138 - m.x138*m.b127 <= 0)

m.c68 = Constraint(expr=m.x156*m.b128 + m.x156*m.x139 - m.x139*m.b128 <= 0)

m.c69 = Constraint(expr=m.x157*m.b129 + m.x157*m.x139 - m.x139*m.b129 <= 0)

m.c70 = Constraint(expr=m.x158*m.b130 + m.x158*m.x139 - m.x139*m.b130 <= 0)

m.c71 = Constraint(expr=m.x159*m.b131 + m.x159*m.x140 - m.x140*m.b131 <= 0)

m.c72 = Constraint(expr=m.x160*m.b132 + m.x160*m.x140 - m.x140*m.b132 <= 0)

m.c73 = Constraint(expr=m.x161*m.b133 + m.x161*m.x140 - m.x140*m.b133 <= 0)
