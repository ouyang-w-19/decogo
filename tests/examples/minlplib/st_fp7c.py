...
m.obj = Objective(expr=(-10*m.x1**2) - 10*m.x2**2 - 10*m.x3**2 - 10*m.x4**2 - 10*m.x5**2 - 10*m.x6**2 - 10*m.x7**2 - 10*
                       m.x8**2 - 10*m.x9**2 - 10*m.x10**2 - 10*m.x11**2 - 10*m.x12**2 - 10*m.x13**2 - 10*m.x14**2 - 10*
                       m.x15**2 - 10*m.x16**2 - 10*m.x17**2 - 10*m.x18**2 - 10*m.x19**2 - 10*m.x20**2, sense=minimize)
