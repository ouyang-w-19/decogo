...
m.c1 = Constraint(expr=   m.x1 + m.x2 + m.x3 + m.x4 + m.x5 + m.x6 <= 500)

m.c2 = Constraint(expr=   m.x1 + 3*m.x2 + 6*m.x3 + 2*m.x4 >= 50)

m.c3 = Constraint(expr=   3*m.x5 + 4*m.x6 >= 50)

m.c4 = Constraint(expr=   m.x3 + 2*m.x4 + 3*m.x5 + m.x6 <= 350)
