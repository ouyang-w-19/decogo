...
m.obj = Objective(expr=   100*m.x675 + 100*m.x676 + 100*m.x677 + 100*m.x679 + 100*m.x681 + 100*m.x682 + 100*m.x683
                        ...
                        + 10*m.b799 + 10*m.b800 + 10*m.b801 + 10000*m.x815 + 10000*m.x816 + 10000*m.x817 + 10000*m.x818
                        + 10000*m.x819 + 10000*m.x820 + 10000*m.x821 + 10000*m.x822 + 10000*m.x823 + 10000*m.x824
                       , sense=minimize)
...
m.c866 = Constraint(expr=   m.x675 - 0.75*m.b782 - m.x815 <= 0)

m.c867 = Constraint(expr=   m.x676 - 0.75*m.b783 - m.x816 <= 0)

m.c868 = Constraint(expr=   m.x677 - 0.75*m.b784 - m.x817 <= 0)

m.c869 = Constraint(expr=   m.x679 - 0.75*m.b785 - m.x818 <= 0)

m.c870 = Constraint(expr=   m.x681 - 0.75*m.b786 - m.x819 <= 0)

m.c871 = Constraint(expr=   m.x682 - 0.75*m.b787 - m.x820 <= 0)

m.c872 = Constraint(expr=   m.x683 - 0.75*m.b788 - m.x821 <= 0)

m.c873 = Constraint(expr=   m.x684 - 0.75*m.b789 - m.x822 <= 0)

m.c874 = Constraint(expr=   m.x685 - 0.75*m.b790 - m.x823 <= 0)

m.c875 = Constraint(expr=   m.x686 - 0.75*m.b791 - m.x824 <= 0)
