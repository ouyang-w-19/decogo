...
m.c1 = Constraint(expr= - m.x1 + m.x16 == -22.8393785915978)
...
m.c8 = Constraint(expr=(m.x4 - m.x6)*(m.x4 - m.x6) + (m.x5 - m.x7)*(m.x5 - m.x7) >= 1.96)

m.c9 = Constraint(expr=(m.x4 - m.x8)*(m.x4 - m.x8) + (m.x5 - m.x9)*(m.x5 - m.x9) >= 5.29)

m.c10 = Constraint(expr=(m.x4 - m.x10)*(m.x4 - m.x10) + (m.x5 - m.x11)*(m.x5 - m.x11) >= 1.21)

m.c11 = Constraint(expr=(m.x4 - m.x12)*(m.x4 - m.x12) + (m.x5 - m.x13)*(m.x5 - m.x13) >= 3.61)

m.c12 = Constraint(expr=(m.x6 - m.x8)*(m.x6 - m.x8) + (m.x7 - m.x9)*(m.x7 - m.x9) >= 6.25)

m.c13 = Constraint(expr=(m.x6 - m.x10)*(m.x6 - m.x10) + (m.x7 - m.x11)*(m.x7 - m.x11) >= 1.69)

m.c14 = Constraint(expr=(m.x6 - m.x12)*(m.x6 - m.x12) + (m.x7 - m.x13)*(m.x7 - m.x13) >= 4.41)

m.c15 = Constraint(expr=(m.x8 - m.x10)*(m.x8 - m.x10) + (m.x9 - m.x11)*(m.x9 - m.x11) >= 4.84)

m.c16 = Constraint(expr=(m.x8 - m.x12)*(m.x8 - m.x12) + (m.x9 - m.x13)*(m.x9 - m.x13) >= 9)

m.c17 = Constraint(expr=(m.x10 - m.x12)*(m.x10 - m.x12) + (m.x11 - m.x13)*(m.x11 - m.x13) >= 3.24)

m.c18 = Constraint(expr=   m.x2 - m.x14 <= -1.2)

m.c19 = Constraint(expr=   m.x3 - m.x15 <= -1.2)

m.c20 = Constraint(expr=   m.x4 - m.x14 <= -0.6)

m.c21 = Constraint(expr=   m.x5 - m.x15 <= -0.6)

m.c22 = Constraint(expr=   m.x6 - m.x14 <= -0.8)

m.c23 = Constraint(expr=   m.x7 - m.x15 <= -0.8)

m.c24 = Constraint(expr=   m.x8 - m.x14 <= -1.7)

m.c25 = Constraint(expr=   m.x9 - m.x15 <= -1.7)

m.c26 = Constraint(expr=   m.x10 - m.x14 <= -0.5)

m.c27 = Constraint(expr=   m.x11 - m.x15 <= -0.5)

m.c28 = Constraint(expr=   m.x12 - m.x14 <= -1.3)

m.c29 = Constraint(expr=   m.x13 - m.x15 <= -1.3)

m.c30 = Constraint(expr=   m.x2 <= 4)

m.c31 = Constraint(expr=   m.x3 <= 2)
