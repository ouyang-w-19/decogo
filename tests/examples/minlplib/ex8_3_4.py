...
m.c8 = Constraint(expr=m.x12*m.x7 - (m.x37*m.x57 + m.x41*m.x62 + m.x45*m.x67 + m.x49*m.x72 + m.x53*m.x77) - 5.8*m.x2
                        == 0)
...
m.c12 = Constraint(expr=m.x16*m.x8 - (m.x37*m.x58 + m.x41*m.x63 + m.x45*m.x68 + m.x49*m.x73 + m.x53*m.x78) - 5.8*m.x3
                         == 0)
...
m.c16 = Constraint(expr=m.x20*m.x9 - (m.x37*m.x59 + m.x41*m.x64 + m.x45*m.x69 + m.x49*m.x74 + m.x53*m.x79) - 5.8*m.x4
                         == 0)
...
m.c20 = Constraint(expr=m.x24*m.x10 - (m.x37*m.x60 + m.x41*m.x65 + m.x45*m.x70 + m.x49*m.x75 + m.x53*m.x80) - 5.8*m.x5
                         == 0)
...
m.c24 = Constraint(expr=m.x28*m.x11 - (m.x37*m.x61 + m.x41*m.x66 + m.x45*m.x71 + m.x49*m.x76 + m.x53*m.x81) - 5.8*m.x6
                         == 0)
