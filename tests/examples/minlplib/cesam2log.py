...
m.obj = Objective(expr=(2.89037157789618 + log(1e-8 + m.x233))*m.x233 + (0.117783024406384 + log(1e-8 + m.x234))*m.x234
                        + (2.89037157789618 + log(1e-8 + m.x235))*m.x235 + (2.89037157789618 + log(1e-8 + m.x236))*
                       m.x236 + (0.117783024406384 + log(1e-8 + m.x237))*m.x237 + (2.89037157789618 + log(1e-8 + m.x238)
                       )*m.x238 + (2.89037157789618 + log(1e-8 + m.x239))*m.x239 + (0.117783024406384 + log(1e-8 + 
                       m.x240))*m.x240 + (2.89037157789618 + log(1e-8 + m.x241))*m.x241 + (2.89037157789618 + log(1e-8
                        + m.x242))*m.x242 + (0.117783024406384 + log(1e-8 + m.x243))*m.x243 + (2.89037157789618 + log(
                       1e-8 + m.x244))*m.x244 + (2.89037157789618 + log(1e-8 + m.x245))*m.x245 + (0.117783024406384 + 
                       log(1e-8 + m.x246))*m.x246 + (2.89037157789618 + log(1e-8 + m.x247))*m.x247 + (2.89037157789618
                        + log(1e-8 + m.x248))*m.x248 + (0.117783024406384 + log(1e-8 + m.x249))*m.x249 + (
                       2.89037157789618 + log(1e-8 + m.x250))*m.x250 + (2.89037157789618 + log(1e-8 + m.x251))*m.x251 + 
                       (0.117783024406384 + log(1e-8 + m.x252))*m.x252 + (2.89037157789618 + log(1e-8 + m.x253))*m.x253
                        + (2.89037157789618 + log(1e-8 + m.x254))*m.x254 + (0.117783024406384 + log(1e-8 + m.x255))*
                       m.x255 + (2.89037157789618 + log(1e-8 + m.x256))*m.x256 + (2.89037157789618 + log(1e-8 + m.x257))
                       *m.x257 + (0.117783024406384 + log(1e-8 + m.x258))*m.x258 + (2.89037157789618 + log(1e-8 + m.x259
                       ))*m.x259 + (2.89037157789618 + log(1e-8 + m.x260))*m.x260 + (0.117783024406384 + log(1e-8 + 
                       m.x261))*m.x261 + (2.89037157789618 + log(1e-8 + m.x262))*m.x262 + (2.89037157789618 + log(1e-8
                        + m.x263))*m.x263 + (0.117783024406384 + log(1e-8 + m.x264))*m.x264 + (2.89037157789618 + log(
                       1e-8 + m.x265))*m.x265 + (2.89037157789618 + log(1e-8 + m.x266))*m.x266 + (0.117783024406384 + 
                       log(1e-8 + m.x267))*m.x267 + (2.89037157789618 + log(1e-8 + m.x268))*m.x268 + (2.89037157789618
                        + log(1e-8 + m.x269))*m.x269 + (0.117783024406384 + log(1e-8 + m.x270))*m.x270 + (
                       2.89037157789618 + log(1e-8 + m.x271))*m.x271 + (2.89037157789618 + log(1e-8 + m.x272))*m.x272 + 
                       (0.117783024406384 + log(1e-8 + m.x273))*m.x273 + (2.89037157789618 + log(1e-8 + m.x274))*m.x274
                        + (2.89037157789618 + log(1e-8 + m.x275))*m.x275 + (0.117783024406384 + log(1e-8 + m.x276))*
                       m.x276 + (2.89037157789618 + log(1e-8 + m.x277))*m.x277 + (2.89037157789618 + log(1e-8 + m.x278))
                       *m.x278 + (0.117783024406384 + log(1e-8 + m.x279))*m.x279 + (2.89037157789618 + log(1e-8 + m.x280
                       ))*m.x280 + (2.89037157789618 + log(1e-8 + m.x281))*m.x281 + (0.117783024406384 + log(1e-8 + 
                       m.x282))*m.x282 + (2.89037157789618 + log(1e-8 + m.x283))*m.x283 + (2.89037157789618 + log(1e-8
                        + m.x284))*m.x284 + (0.117783024406384 + log(1e-8 + m.x285))*m.x285 + (2.89037157789618 + log(
                       1e-8 + m.x286))*m.x286 + (2.89037157789618 + log(1e-8 + m.x287))*m.x287 + (0.117783024406384 + 
                       log(1e-8 + m.x288))*m.x288 + (2.89037157789618 + log(1e-8 + m.x289))*m.x289 + (2.89037157789618
                        + log(1e-8 + m.x290))*m.x290 + (0.117783024406384 + log(1e-8 + m.x291))*m.x291 + (
                       2.89037157789618 + log(1e-8 + m.x292))*m.x292 + (2.89037157789618 + log(1e-8 + m.x293))*m.x293 + 
                       (0.117783024406384 + log(1e-8 + m.x294))*m.x294 + (2.89037157789618 + log(1e-8 + m.x295))*m.x295
                        + (2.89037157789618 + log(1e-8 + m.x296))*m.x296 + (0.117783024406384 + log(1e-8 + m.x297))*
                       m.x297 + (2.89037157789618 + log(1e-8 + m.x298))*m.x298 + (2.89037157789618 + log(1e-8 + m.x299))
                       *m.x299 + (0.117783024406384 + log(1e-8 + m.x300))*m.x300 + (2.89037157789618 + log(1e-8 + m.x301
                       ))*m.x301 + (2.89037157789618 + log(1e-8 + m.x302))*m.x302 + (0.117783024406384 + log(1e-8 + 
                       m.x303))*m.x303 + (2.89037157789618 + log(1e-8 + m.x304))*m.x304 + (2.89037157789618 + log(1e-8
                        + m.x305))*m.x305 + (0.117783024406384 + log(1e-8 + m.x306))*m.x306 + (2.89037157789618 + log(
                       1e-8 + m.x307))*m.x307 + (2.89037157789618 + log(1e-8 + m.x308))*m.x308 + (0.117783024406384 + 
                       log(1e-8 + m.x309))*m.x309 + (2.89037157789618 + log(1e-8 + m.x310))*m.x310 + (2.89037157789618
                        + log(1e-8 + m.x311))*m.x311 + (0.117783024406384 + log(1e-8 + m.x312))*m.x312 + (
                       2.89037157789618 + log(1e-8 + m.x313))*m.x313 + (2.89037157789618 + log(1e-8 + m.x314))*m.x314 + 
                       (0.117783024406384 + log(1e-8 + m.x315))*m.x315 + (2.89037157789618 + log(1e-8 + m.x316))*m.x316
                        + (1.94591007905532 + log(1e-8 + m.x160))*m.x160 + (1.94591007905532 + log(1e-8 + m.x161))*
                       m.x161 + (1.94591007905532 + log(1e-8 + m.x162))*m.x162 + (1.94591007905532 + log(1e-8 + m.x163))
                       *m.x163 + (1.94591007905532 + log(1e-8 + m.x164))*m.x164 + (1.94591007905532 + log(1e-8 + m.x165)
                       )*m.x165 + (1.94591007905532 + log(1e-8 + m.x166))*m.x166 + (1.94591007905532 + log(1e-8 + m.x167
                       ))*m.x167 + (1.94591007905532 + log(1e-8 + m.x168))*m.x168 + (1.94591007905532 + log(1e-8 + 
                       m.x169))*m.x169 + (1.94591007905532 + log(1e-8 + m.x170))*m.x170 + (1.94591007905532 + log(1e-8
                        + m.x171))*m.x171 + (1.94591007905532 + log(1e-8 + m.x172))*m.x172 + (1.94591007905532 + log(
                       1e-8 + m.x173))*m.x173 + (1.94591007905532 + log(1e-8 + m.x174))*m.x174 + (1.94591007905532 + 
                       log(1e-8 + m.x175))*m.x175 + (1.94591007905532 + log(1e-8 + m.x176))*m.x176 + (1.94591007905532
                        + log(1e-8 + m.x177))*m.x177 + (1.94591007905532 + log(1e-8 + m.x178))*m.x178 + (
                       1.94591007905532 + log(1e-8 + m.x179))*m.x179 + (1.94591007905532 + log(1e-8 + m.x180))*m.x180 + 
                       (1.94591007905532 + log(1e-8 + m.x181))*m.x181 + (1.94591007905532 + log(1e-8 + m.x182))*m.x182
                        + (1.94591007905532 + log(1e-8 + m.x183))*m.x183 + (1.94591007905532 + log(1e-8 + m.x184))*
                       m.x184 + (1.94591007905532 + log(1e-8 + m.x185))*m.x185 + (1.94591007905532 + log(1e-8 + m.x186))
                       *m.x186 + (1.94591007905532 + log(1e-8 + m.x187))*m.x187 + (1.94591007905532 + log(1e-8 + m.x188)
                       )*m.x188 + (1.94591007905532 + log(1e-8 + m.x189))*m.x189 + (1.94591007905532 + log(1e-8 + m.x190
                       ))*m.x190 + (1.94591007905532 + log(1e-8 + m.x191))*m.x191 + (1.94591007905532 + log(1e-8 + 
                       m.x192))*m.x192 + (1.94591007905532 + log(1e-8 + m.x193))*m.x193 + (1.94591007905532 + log(1e-8
                        + m.x194))*m.x194 + (1.94591007905532 + log(1e-8 + m.x195))*m.x195 + (1.94591007905532 + log(
                       1e-8 + m.x196))*m.x196 + (1.94591007905532 + log(1e-8 + m.x197))*m.x197 + (1.94591007905532 + 
                       log(1e-8 + m.x198))*m.x198 + (1.94591007905532 + log(1e-8 + m.x199))*m.x199 + (1.94591007905532
                        + log(1e-8 + m.x200))*m.x200 + (1.94591007905532 + log(1e-8 + m.x201))*m.x201 + (
                       1.94591007905532 + log(1e-8 + m.x202))*m.x202 + (1.94591007905532 + log(1e-8 + m.x203))*m.x203 + 
                       (1.94591007905532 + log(1e-8 + m.x204))*m.x204 + (1.94591007905532 + log(1e-8 + m.x205))*m.x205
                        + (1.94591007905532 + log(1e-8 + m.x206))*m.x206 + (1.94591007905532 + log(1e-8 + m.x207))*
                       m.x207 + (1.94591007905532 + log(1e-8 + m.x208))*m.x208 + (1.94591007905532 + log(1e-8 + m.x209))
                       *m.x209 + (1.94591007905532 + log(1e-8 + m.x210))*m.x210 + (1.94591007905532 + log(1e-8 + m.x211)
                       )*m.x211 + (1.94591007905532 + log(1e-8 + m.x212))*m.x212 + (1.94591007905532 + log(1e-8 + m.x213
                       ))*m.x213 + (1.94591007905532 + log(1e-8 + m.x214))*m.x214 + (1.94591007905532 + log(1e-8 + 
                       m.x215))*m.x215 + (1.94591007905532 + log(1e-8 + m.x216))*m.x216 + (1.94591007905532 + log(1e-8
                        + m.x217))*m.x217 + (1.94591007905532 + log(1e-8 + m.x218))*m.x218 + (1.94591007905532 + log(
                       1e-8 + m.x219))*m.x219 + (1.94591007905532 + log(1e-8 + m.x220))*m.x220 + (1.94591007905532 + 
                       log(1e-8 + m.x221))*m.x221 + (1.94591007905532 + log(1e-8 + m.x222))*m.x222 + (5.0875947152337 + 
                       log(1e-8 + m.x223))*m.x223 + (1.62186038180766 + log(1e-8 + m.x224))*m.x224 + (0.523248126889548
                        + log(1e-8 + m.x225))*m.x225 + (1.62186038180766 + log(1e-8 + m.x226))*m.x226 + (5.0875947152337
                        + log(1e-8 + m.x227))*m.x227 + (5.0875947152337 + log(1e-8 + m.x228))*m.x228 + (1.62186038180766
                        + log(1e-8 + m.x229))*m.x229 + (0.523248126889548 + log(1e-8 + m.x230))*m.x230 + (
                       1.62186038180766 + log(1e-8 + m.x231))*m.x231 + (5.0875947152337 + log(1e-8 + m.x232))*m.x232
                       , sense=minimize)
