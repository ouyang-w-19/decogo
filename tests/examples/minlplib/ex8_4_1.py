...
m.c2 = Constraint(expr=m.x22*m.x1 - m.x2 + m.x21 == 0)

m.c3 = Constraint(expr=m.x22*m.x3 - m.x4 + m.x21 == 0)

m.c4 = Constraint(expr=m.x22*m.x5 - m.x6 + m.x21 == 0)

m.c5 = Constraint(expr=m.x22*m.x7 - m.x8 + m.x21 == 0)

m.c6 = Constraint(expr=m.x22*m.x9 - m.x10 + m.x21 == 0)

m.c7 = Constraint(expr=m.x22*m.x11 - m.x12 + m.x21 == 0)

m.c8 = Constraint(expr=m.x22*m.x13 - m.x14 + m.x21 == 0)

m.c9 = Constraint(expr=m.x22*m.x15 - m.x16 + m.x21 == 0)

m.c10 = Constraint(expr=m.x22*m.x17 - m.x18 + m.x21 == 0)

m.c11 = Constraint(expr=m.x22*m.x19 - m.x20 + m.x21 == 0)
