...
m.x145 = Var(within=Reals,bounds=(0,None),initialize=1.6087063301402)
m.x146 = Var(within=Reals,bounds=(0,None),initialize=3.98267557388175)
m.x147 = Var(within=Reals,bounds=(0,None),initialize=1.60194612605143)
m.x148 = Var(within=Reals,bounds=(0,None),initialize=1.62330360892806)
m.x149 = Var(within=Reals,bounds=(0,None),initialize=2.27604466639882)
m.x150 = Var(within=Reals,bounds=(0,None),initialize=1.42636562172377)
m.x151 = Var(within=Reals,bounds=(0,None),initialize=1.67243339752216)
m.x152 = Var(within=Reals,bounds=(0,None),initialize=1.74247700111916)
m.x153 = Var(within=Reals,bounds=(0,None),initialize=0.205556078576023)
m.x154 = Var(within=Reals,bounds=(0,None),initialize=0.205556078576023)
m.x155 = Var(within=Reals,bounds=(0,None),initialize=0.205556078576023)
m.x156 = Var(within=Reals,bounds=(0,None),initialize=0.266434871173645)
m.x157 = Var(within=Reals,bounds=(0,None),initialize=0.266434871173645)
m.x158 = Var(within=Reals,bounds=(0,None),initialize=0.266434871173645)
m.x159 = Var(within=Reals,bounds=(0,None),initialize=0.205224096175844)
m.x160 = Var(within=Reals,bounds=(0,None),initialize=0.205224096175844)
m.x161 = Var(within=Reals,bounds=(0,None),initialize=0.205224096175844)
m.x162 = Var(within=Reals,bounds=(0,None),initialize=0.206267090524503)
m.x163 = Var(within=Reals,bounds=(0,None),initialize=0.206267090524503)
m.x164 = Var(within=Reals,bounds=(0,None),initialize=0.206267090524503)
m.x165 = Var(within=Reals,bounds=(0,None),initialize=0.231584618869147)
m.x166 = Var(within=Reals,bounds=(0,None),initialize=0.231584618869147)
m.x167 = Var(within=Reals,bounds=(0,None),initialize=0.231584618869147)
m.x168 = Var(within=Reals,bounds=(0,None),initialize=0.195953653062178)
m.x169 = Var(within=Reals,bounds=(0,None),initialize=0.195953653062178)
m.x170 = Var(within=Reals,bounds=(0,None),initialize=0.195953653062178)
m.x171 = Var(within=Reals,bounds=(0,None),initialize=0.208603065539795)
m.x172 = Var(within=Reals,bounds=(0,None),initialize=0.208603065539795)
m.x173 = Var(within=Reals,bounds=(0,None),initialize=0.208603065539795)
m.x174 = Var(within=Reals,bounds=(0,None),initialize=0.211788710280048)
m.x175 = Var(within=Reals,bounds=(0,None),initialize=0.211788710280048)
m.x176 = Var(within=Reals,bounds=(0,None),initialize=0.211788710280048)
...
m.c57 = Constraint(expr=m.x153*m.b121 + m.x153*m.x145 - m.x145*m.b121 <= 0)

m.c58 = Constraint(expr=m.x154*m.b122 + m.x154*m.x145 - m.x145*m.b122 <= 0)

m.c59 = Constraint(expr=m.x155*m.b123 + m.x155*m.x145 - m.x145*m.b123 <= 0)

m.c60 = Constraint(expr=m.x156*m.b124 + m.x156*m.x146 - m.x146*m.b124 <= 0)

m.c61 = Constraint(expr=m.x157*m.b125 + m.x157*m.x146 - m.x146*m.b125 <= 0)

m.c62 = Constraint(expr=m.x158*m.b126 + m.x158*m.x146 - m.x146*m.b126 <= 0)

m.c63 = Constraint(expr=m.x159*m.b127 + m.x159*m.x147 - m.x147*m.b127 <= 0)

m.c64 = Constraint(expr=m.x160*m.b128 + m.x160*m.x147 - m.x147*m.b128 <= 0)

m.c65 = Constraint(expr=m.x161*m.b129 + m.x161*m.x147 - m.x147*m.b129 <= 0)

m.c66 = Constraint(expr=m.x162*m.b130 + m.x162*m.x148 - m.x148*m.b130 <= 0)

m.c67 = Constraint(expr=m.x163*m.b131 + m.x163*m.x148 - m.x148*m.b131 <= 0)

m.c68 = Constraint(expr=m.x164*m.b132 + m.x164*m.x148 - m.x148*m.b132 <= 0)

m.c69 = Constraint(expr=m.x165*m.b133 + m.x165*m.x149 - m.x149*m.b133 <= 0)

m.c70 = Constraint(expr=m.x166*m.b134 + m.x166*m.x149 - m.x149*m.b134 <= 0)

m.c71 = Constraint(expr=m.x167*m.b135 + m.x167*m.x149 - m.x149*m.b135 <= 0)

m.c72 = Constraint(expr=m.x168*m.b136 + m.x168*m.x150 - m.x150*m.b136 <= 0)

m.c73 = Constraint(expr=m.x169*m.b137 + m.x169*m.x150 - m.x150*m.b137 <= 0)

m.c74 = Constraint(expr=m.x170*m.b138 + m.x170*m.x150 - m.x150*m.b138 <= 0)

m.c75 = Constraint(expr=m.x171*m.b139 + m.x171*m.x151 - m.x151*m.b139 <= 0)

m.c76 = Constraint(expr=m.x172*m.b140 + m.x172*m.x151 - m.x151*m.b140 <= 0)

m.c77 = Constraint(expr=m.x173*m.b141 + m.x173*m.x151 - m.x151*m.b141 <= 0)

m.c78 = Constraint(expr=m.x174*m.b142 + m.x174*m.x152 - m.x152*m.b142 <= 0)

m.c79 = Constraint(expr=m.x175*m.b143 + m.x175*m.x152 - m.x152*m.b143 <= 0)

m.c80 = Constraint(expr=m.x176*m.b144 + m.x176*m.x152 - m.x152*m.b144 <= 0)
