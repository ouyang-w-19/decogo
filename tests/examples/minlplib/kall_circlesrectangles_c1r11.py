...
m.x4 = Var(within=Reals,bounds=(0,8.94427190999916),initialize=0)
m.x5 = Var(within=Reals,bounds=(0,8.94427190999916),initialize=0)
m.x6 = Var(within=Reals,bounds=(0,8.94427190999916),initialize=0)
m.x7 = Var(within=Reals,bounds=(0,8.94427190999916),initialize=0)
m.x8 = Var(within=Reals,bounds=(-8.94427190999916,8.94427190999916),initialize=0)
m.x9 = Var(within=Reals,bounds=(-8.94427190999916,8.94427190999916),initialize=0)
m.x10 = Var(within=Reals,bounds=(-8.94427190999916,8.94427190999916),initialize=0)
m.x11 = Var(within=Reals,bounds=(-8.94427190999916,8.94427190999916),initialize=0)
m.x12 = Var(within=Reals,bounds=(-8.94427190999916,8.94427190999916),initialize=0)
...
m.x17 = Var(within=Reals,bounds=(-8.94427190999916,8.94427190999916),initialize=0)
m.x18 = Var(within=Reals,bounds=(-8.94427190999916,8.94427190999916),initialize=0)
m.x19 = Var(within=Reals,bounds=(-8.94427190999916,8.94427190999916),initialize=0)
...
m.x27 = Var(within=Reals,bounds=(-0.1,0.1),initialize=0)
m.x28 = Var(within=Reals,bounds=(-0.15,0.15),initialize=0)
m.x29 = Var(within=Reals,bounds=(-0.1,0.1),initialize=0)
m.x30 = Var(within=Reals,bounds=(-0.15,0.15),initialize=0)
m.x31 = Var(within=Reals,bounds=(-0.1,0.1),initialize=0)
m.x32 = Var(within=Reals,bounds=(-0.15,0.15),initialize=0)
m.x33 = Var(within=Reals,bounds=(-0.1,0.1),initialize=0)
m.x34 = Var(within=Reals,bounds=(-0.15,0.15),initialize=0)
m.x35 = Var(within=Reals,bounds=(0.5,7.5),initialize=0.5)
m.x36 = Var(within=Reals,bounds=(0.5,3.5),initialize=0.5)
m.x37 = Var(within=Reals,bounds=(0,8),initialize=0)
m.x38 = Var(within=Reals,bounds=(0,4),initialize=0)
m.x39 = Var(within=Reals,bounds=(0,8),initialize=0)
m.x40 = Var(within=Reals,bounds=(0,4),initialize=0)
m.x41 = Var(within=Reals,bounds=(0,8),initialize=0)
m.x42 = Var(within=Reals,bounds=(0,4),initialize=0)
m.x43 = Var(within=Reals,bounds=(0,8),initialize=0)
m.x44 = Var(within=Reals,bounds=(0,4),initialize=0)
m.x45 = Var(within=Reals,bounds=(0,8),initialize=0)
m.x46 = Var(within=Reals,bounds=(0,4),initialize=0)
m.x47 = Var(within=Reals,bounds=(0,8),initialize=0)
m.x48 = Var(within=Reals,bounds=(0,4),initialize=0)
m.x49 = Var(within=Reals,bounds=(0,32),initialize=0)

m.obj = Objective(expr=m.x49, sense=minimize)

m.c1 = Constraint(expr= - m.x1 + m.x49 == -0.800398163397448)
...
m.c26 = Constraint(expr=m.x27*m.x27 + m.x28*m.x28 == 0.0225)

m.c27 = Constraint(expr=m.x29*m.x29 + m.x30*m.x30 == 0.01)
...
m.c51 = Constraint(expr=   m.x35 <= 4)

m.c52 = Constraint(expr=   m.x36 <= 2)
