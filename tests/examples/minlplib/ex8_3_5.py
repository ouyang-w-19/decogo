...
m.c53 = Constraint(expr= - m.x37 + m.x97 == 0)

m.c54 = Constraint(expr= - m.x41 + m.x100 == 0)

m.c55 = Constraint(expr= - m.x45 + m.x103 == 0)

m.c56 = Constraint(expr= - m.x49 + m.x106 == 0)

m.c57 = Constraint(expr= - m.x53 + m.x109 == 0)

m.c58 = Constraint(expr= - 2*m.x38 + m.x98 == 0)

m.c59 = Constraint(expr= - 2*m.x42 + m.x101 == 0)

m.c60 = Constraint(expr= - 2*m.x46 + m.x104 == 0)

m.c61 = Constraint(expr= - 2*m.x50 + m.x107 == 0)

m.c62 = Constraint(expr= - 2*m.x54 + m.x110 == 0)

m.c63 = Constraint(expr=-10*m.x37*m.x37 + m.x99 == 0)

m.c64 = Constraint(expr=-10*m.x41*m.x41 + m.x102 == 0)

m.c65 = Constraint(expr=-10*m.x45*m.x45 + m.x105 == 0)

m.c66 = Constraint(expr=-10*m.x49*m.x49 + m.x108 == 0)

m.c67 = Constraint(expr=-10*m.x53*m.x53 + m.x111 == 0)
