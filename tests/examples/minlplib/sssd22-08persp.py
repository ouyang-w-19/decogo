...
m.x201 = Var(within=Reals,bounds=(0,None),initialize=1.54709273216915)
m.x202 = Var(within=Reals,bounds=(0,None),initialize=1.86524351951116)
m.x203 = Var(within=Reals,bounds=(0,None),initialize=1.26103309126974)
m.x204 = Var(within=Reals,bounds=(0,None),initialize=1.47633486853575)
m.x205 = Var(within=Reals,bounds=(0,None),initialize=1.9493854998908)
m.x206 = Var(within=Reals,bounds=(0,None),initialize=1.24633304234106)
m.x207 = Var(within=Reals,bounds=(0,None),initialize=1.84229622639189)
m.x208 = Var(within=Reals,bounds=(0,None),initialize=2.26070041222848)
m.x209 = Var(within=Reals,bounds=(0,None),initialize=0.202465175639891)
m.x210 = Var(within=Reals,bounds=(0,None),initialize=0.202465175639891)
m.x211 = Var(within=Reals,bounds=(0,None),initialize=0.202465175639891)
m.x212 = Var(within=Reals,bounds=(0,None),initialize=0.216996508535208)
m.x213 = Var(within=Reals,bounds=(0,None),initialize=0.216996508535208)
m.x214 = Var(within=Reals,bounds=(0,None),initialize=0.216996508535208)
m.x215 = Var(within=Reals,bounds=(0,None),initialize=0.185908098992273)
m.x216 = Var(within=Reals,bounds=(0,None),initialize=0.185908098992273)
m.x217 = Var(within=Reals,bounds=(0,None),initialize=0.185908098992273)
m.x218 = Var(within=Reals,bounds=(0,None),initialize=0.198725797992028)
m.x219 = Var(within=Reals,bounds=(0,None),initialize=0.198725797992028)
m.x220 = Var(within=Reals,bounds=(0,None),initialize=0.198725797992028)
m.x221 = Var(within=Reals,bounds=(0,None),initialize=0.220315440844991)
m.x222 = Var(within=Reals,bounds=(0,None),initialize=0.220315440844991)
m.x223 = Var(within=Reals,bounds=(0,None),initialize=0.220315440844991)
m.x224 = Var(within=Reals,bounds=(0,None),initialize=0.184943345272639)
m.x225 = Var(within=Reals,bounds=(0,None),initialize=0.184943345272639)
m.x226 = Var(within=Reals,bounds=(0,None),initialize=0.184943345272639)
m.x227 = Var(within=Reals,bounds=(0,None),initialize=0.216057262585254)
m.x228 = Var(within=Reals,bounds=(0,None),initialize=0.216057262585254)
m.x229 = Var(within=Reals,bounds=(0,None),initialize=0.216057262585254)
m.x230 = Var(within=Reals,bounds=(0,None),initialize=0.231105808203074)
m.x231 = Var(within=Reals,bounds=(0,None),initialize=0.231105808203074)
m.x232 = Var(within=Reals,bounds=(0,None),initialize=0.231105808203074)
...
m.c64 = Constraint(expr=m.x209*m.b177 + m.x209*m.x201 - m.x201*m.b177 <= 0)

m.c65 = Constraint(expr=m.x210*m.b178 + m.x210*m.x201 - m.x201*m.b178 <= 0)

m.c66 = Constraint(expr=m.x211*m.b179 + m.x211*m.x201 - m.x201*m.b179 <= 0)

m.c67 = Constraint(expr=m.x212*m.b180 + m.x212*m.x202 - m.x202*m.b180 <= 0)

m.c68 = Constraint(expr=m.x213*m.b181 + m.x213*m.x202 - m.x202*m.b181 <= 0)

m.c69 = Constraint(expr=m.x214*m.b182 + m.x214*m.x202 - m.x202*m.b182 <= 0)

m.c70 = Constraint(expr=m.x215*m.b183 + m.x215*m.x203 - m.x203*m.b183 <= 0)

m.c71 = Constraint(expr=m.x216*m.b184 + m.x216*m.x203 - m.x203*m.b184 <= 0)

m.c72 = Constraint(expr=m.x217*m.b185 + m.x217*m.x203 - m.x203*m.b185 <= 0)

m.c73 = Constraint(expr=m.x218*m.b186 + m.x218*m.x204 - m.x204*m.b186 <= 0)

m.c74 = Constraint(expr=m.x219*m.b187 + m.x219*m.x204 - m.x204*m.b187 <= 0)

m.c75 = Constraint(expr=m.x220*m.b188 + m.x220*m.x204 - m.x204*m.b188 <= 0)

m.c76 = Constraint(expr=m.x221*m.b189 + m.x221*m.x205 - m.x205*m.b189 <= 0)

m.c77 = Constraint(expr=m.x222*m.b190 + m.x222*m.x205 - m.x205*m.b190 <= 0)

m.c78 = Constraint(expr=m.x223*m.b191 + m.x223*m.x205 - m.x205*m.b191 <= 0)

m.c79 = Constraint(expr=m.x224*m.b192 + m.x224*m.x206 - m.x206*m.b192 <= 0)

m.c80 = Constraint(expr=m.x225*m.b193 + m.x225*m.x206 - m.x206*m.b193 <= 0)

m.c81 = Constraint(expr=m.x226*m.b194 + m.x226*m.x206 - m.x206*m.b194 <= 0)

m.c82 = Constraint(expr=m.x227*m.b195 + m.x227*m.x207 - m.x207*m.b195 <= 0)

m.c83 = Constraint(expr=m.x228*m.b196 + m.x228*m.x207 - m.x207*m.b196 <= 0)

m.c84 = Constraint(expr=m.x229*m.b197 + m.x229*m.x207 - m.x207*m.b197 <= 0)

m.c85 = Constraint(expr=m.x230*m.b198 + m.x230*m.x208 - m.x208*m.b198 <= 0)

m.c86 = Constraint(expr=m.x231*m.b199 + m.x231*m.x208 - m.x208*m.b199 <= 0)

m.c87 = Constraint(expr=m.x232*m.b200 + m.x232*m.x208 - m.x208*m.b200 <= 0)
