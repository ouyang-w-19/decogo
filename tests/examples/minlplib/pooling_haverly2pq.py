...
m.c2 = Constraint(expr=   m.x8 + m.x9 <= 800)

m.c3 = Constraint(expr=   m.x10 + m.x11 <= 800)

m.c4 = Constraint(expr=   m.x4 + m.x5 <= 800)

m.c5 = Constraint(expr=   m.x8 + m.x9 + m.x10 + m.x11 <= 800)

m.c6 = Constraint(expr=   m.x4 + m.x8 + m.x10 <= 600)
