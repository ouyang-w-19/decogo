...
m.x109 = Var(within=Reals,bounds=(0,None),initialize=1.95661643253872)
m.x110 = Var(within=Reals,bounds=(0,None),initialize=1.78971829327967)
m.x111 = Var(within=Reals,bounds=(0,None),initialize=2.70518587938995)
m.x112 = Var(within=Reals,bounds=(0,None),initialize=6.56488423134397)
m.x113 = Var(within=Reals,bounds=(0,None),initialize=2.00751717462227)
m.x114 = Var(within=Reals,bounds=(0,None),initialize=2.11857276701815)
m.x115 = Var(within=Reals,bounds=(0,None),initialize=0.220591846252064)
m.x116 = Var(within=Reals,bounds=(0,None),initialize=0.220591846252064)
m.x117 = Var(within=Reals,bounds=(0,None),initialize=0.220591846252064)
m.x118 = Var(within=Reals,bounds=(0,None),initialize=0.213846955753088)
m.x119 = Var(within=Reals,bounds=(0,None),initialize=0.213846955753088)
m.x120 = Var(within=Reals,bounds=(0,None),initialize=0.213846955753088)
m.x121 = Var(within=Reals,bounds=(0,None),initialize=0.243369335794776)
m.x122 = Var(within=Reals,bounds=(0,None),initialize=0.243369335794776)
m.x123 = Var(within=Reals,bounds=(0,None),initialize=0.243369335794776)
m.x124 = Var(within=Reals,bounds=(0,None),initialize=0.28927009017725)
m.x125 = Var(within=Reals,bounds=(0,None),initialize=0.28927009017725)
m.x126 = Var(within=Reals,bounds=(0,None),initialize=0.28927009017725)
m.x127 = Var(within=Reals,bounds=(0,None),initialize=0.222499940212245)
m.x128 = Var(within=Reals,bounds=(0,None),initialize=0.222499940212245)
m.x129 = Var(within=Reals,bounds=(0,None),initialize=0.222499940212245)
m.x130 = Var(within=Reals,bounds=(0,None),initialize=0.226446831642994)
m.x131 = Var(within=Reals,bounds=(0,None),initialize=0.226446831642994)
m.x132 = Var(within=Reals,bounds=(0,None),initialize=0.226446831642994)
...
m.c47 = Constraint(expr=m.x115*m.b91 + m.x115*m.x109 - m.x109*m.b91 <= 0)

m.c48 = Constraint(expr=m.x116*m.b92 + m.x116*m.x109 - m.x109*m.b92 <= 0)

m.c49 = Constraint(expr=m.x117*m.b93 + m.x117*m.x109 - m.x109*m.b93 <= 0)

m.c50 = Constraint(expr=m.x118*m.b94 + m.x118*m.x110 - m.x110*m.b94 <= 0)

m.c51 = Constraint(expr=m.x119*m.b95 + m.x119*m.x110 - m.x110*m.b95 <= 0)

m.c52 = Constraint(expr=m.x120*m.b96 + m.x120*m.x110 - m.x110*m.b96 <= 0)

m.c53 = Constraint(expr=m.x121*m.b97 + m.x121*m.x111 - m.x111*m.b97 <= 0)

m.c54 = Constraint(expr=m.x122*m.b98 + m.x122*m.x111 - m.x111*m.b98 <= 0)

m.c55 = Constraint(expr=m.x123*m.b99 + m.x123*m.x111 - m.x111*m.b99 <= 0)

m.c56 = Constraint(expr=m.x124*m.b100 + m.x124*m.x112 - m.x112*m.b100 <= 0)

m.c57 = Constraint(expr=m.x125*m.b101 + m.x125*m.x112 - m.x112*m.b101 <= 0)

m.c58 = Constraint(expr=m.x126*m.b102 + m.x126*m.x112 - m.x112*m.b102 <= 0)

m.c59 = Constraint(expr=m.x127*m.b103 + m.x127*m.x113 - m.x113*m.b103 <= 0)

m.c60 = Constraint(expr=m.x128*m.b104 + m.x128*m.x113 - m.x113*m.b104 <= 0)

m.c61 = Constraint(expr=m.x129*m.b105 + m.x129*m.x113 - m.x113*m.b105 <= 0)

m.c62 = Constraint(expr=m.x130*m.b106 + m.x130*m.x114 - m.x114*m.b106 <= 0)

m.c63 = Constraint(expr=m.x131*m.b107 + m.x131*m.x114 - m.x114*m.b107 <= 0)

m.c64 = Constraint(expr=m.x132*m.b108 + m.x132*m.x114 - m.x114*m.b108 <= 0)
