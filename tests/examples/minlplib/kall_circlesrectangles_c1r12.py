...
m.x28 = Var(within=Reals,bounds=(-0.75,0.75),initialize=0)
m.x29 = Var(within=Reals,bounds=(-0.5,0.5),initialize=0)
m.x30 = Var(within=Reals,bounds=(-0.75,0.75),initialize=0)
m.x31 = Var(within=Reals,bounds=(-0.5,0.5),initialize=0)
m.x32 = Var(within=Reals,bounds=(-0.75,0.75),initialize=0)
m.x33 = Var(within=Reals,bounds=(-0.5,0.5),initialize=0)
m.x34 = Var(within=Reals,bounds=(-0.75,0.75),initialize=0)
...
m.c1 = Constraint(expr= - m.x1 + m.x49 == -1.16039816339745)
...
m.c26 = Constraint(expr=m.x27*m.x27 + m.x28*m.x28 == 0.5625)

m.c27 = Constraint(expr=m.x29*m.x29 + m.x30*m.x30 == 0.25)
