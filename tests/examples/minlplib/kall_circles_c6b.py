...
m.x1 = Var(within=Reals,bounds=(0.81,23.2),initialize=0.81)
m.x2 = Var(within=Reals,bounds=(0.5,7.5),initialize=0.5)
m.x3 = Var(within=Reals,bounds=(0.5,2.4),initialize=0.5)
m.x4 = Var(within=Reals,bounds=(0.5,7.5),initialize=0.5)
m.x5 = Var(within=Reals,bounds=(0.5,2.4),initialize=0.5)
m.x6 = Var(within=Reals,bounds=(0.5,7.5),initialize=0.5)
m.x7 = Var(within=Reals,bounds=(0.5,2.4),initialize=0.5)
m.x8 = Var(within=Reals,bounds=(0.5,7.5),initialize=0.5)
m.x9 = Var(within=Reals,bounds=(0.5,2.4),initialize=0.5)
m.x10 = Var(within=Reals,bounds=(0.5,7.5),initialize=0.5)
m.x11 = Var(within=Reals,bounds=(0.5,2.4),initialize=0.5)
m.x12 = Var(within=Reals,bounds=(0.5,7.5),initialize=0.5)
m.x13 = Var(within=Reals,bounds=(0.5,2.4),initialize=0.5)
m.x14 = Var(within=Reals,bounds=(0.9,7.1),initialize=0.9)
m.x15 = Var(within=Reals,bounds=(0.9,2),initialize=0.9)
m.x16 = Var(within=Reals,bounds=(0,8),initialize=0)
m.x17 = Var(within=Reals,bounds=(0,2.9),initialize=0)
m.x18 = Var(within=Reals,bounds=(0,23.2),initialize=0)

m.obj = Objective(expr=m.x18, sense=minimize)

m.c1 = Constraint(expr= - m.x1 + m.x18 == -7.25707902979242)
...
m.c8 = Constraint(expr=(m.x2 - m.x14)*(m.x2 - m.x14) + (m.x3 - m.x15)*(m.x3 - m.x15) >= 1.96)
...
m.c13 = Constraint(expr=(m.x4 - m.x14)*(m.x4 - m.x14) + (m.x5 - m.x15)*(m.x5 - m.x15) >= 1.96)
...
m.c20 = Constraint(expr=(m.x8 - m.x14)*(m.x8 - m.x14) + (m.x9 - m.x15)*(m.x9 - m.x15) >= 1.96)

m.c21 = Constraint(expr=(m.x10 - m.x12)*(m.x10 - m.x12) + (m.x11 - m.x13)*(m.x11 - m.x13) >= 1)

m.c22 = Constraint(expr=(m.x10 - m.x14)*(m.x10 - m.x14) + (m.x11 - m.x15)*(m.x11 - m.x15) >= 1.96)

m.c23 = Constraint(expr=(m.x12 - m.x14)*(m.x12 - m.x14) + (m.x13 - m.x15)*(m.x13 - m.x15) >= 1.96)
...
m.c36 = Constraint(expr=   m.x14 - m.x16 <= -0.9)

m.c37 = Constraint(expr=   m.x15 - m.x17 <= -0.9)

m.c38 = Constraint(expr=   m.x2 <= 4)

m.c39 = Constraint(expr=   m.x3 <= 1.45)
...
m.c45 = Constraint(expr=   m.x4 - m.x6 <= 0)

m.c46 = Constraint(expr=   m.x4 - m.x8 <= 0)

m.c47 = Constraint(expr=   m.x4 - m.x10 <= 0)

m.c48 = Constraint(expr=   m.x4 - m.x12 <= 0)

m.c49 = Constraint(expr=   m.x6 - m.x8 <= 0)

m.c50 = Constraint(expr=   m.x6 - m.x10 <= 0)

m.c51 = Constraint(expr=   m.x6 - m.x12 <= 0)

m.c52 = Constraint(expr=   m.x8 - m.x10 <= 0)

m.c53 = Constraint(expr=   m.x8 - m.x12 <= 0)

m.c54 = Constraint(expr=   m.x10 - m.x12 <= 0)
