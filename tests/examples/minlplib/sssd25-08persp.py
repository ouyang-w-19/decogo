...
m.x225 = Var(within=Reals,bounds=(0,None),initialize=1.76173978558306)
m.x226 = Var(within=Reals,bounds=(0,None),initialize=1.14800359600003)
m.x227 = Var(within=Reals,bounds=(0,None),initialize=2.19189870441685)
m.x228 = Var(within=Reals,bounds=(0,None),initialize=1.01769006492218)
m.x229 = Var(within=Reals,bounds=(0,None),initialize=1.36145384539521)
m.x230 = Var(within=Reals,bounds=(0,None),initialize=1.15959322405736)
m.x231 = Var(within=Reals,bounds=(0,None),initialize=1.1500619524681)
m.x232 = Var(within=Reals,bounds=(0,None),initialize=1.16315705387938)
m.x233 = Var(within=Reals,bounds=(0,None),initialize=0.212636468598497)
m.x234 = Var(within=Reals,bounds=(0,None),initialize=0.212636468598497)
m.x235 = Var(within=Reals,bounds=(0,None),initialize=0.212636468598497)
m.x236 = Var(within=Reals,bounds=(0,None),initialize=0.178150477050383)
m.x237 = Var(within=Reals,bounds=(0,None),initialize=0.178150477050383)
m.x238 = Var(within=Reals,bounds=(0,None),initialize=0.178150477050383)
m.x239 = Var(within=Reals,bounds=(0,None),initialize=0.228902283290274)
m.x240 = Var(within=Reals,bounds=(0,None),initialize=0.228902283290274)
m.x241 = Var(within=Reals,bounds=(0,None),initialize=0.228902283290274)
m.x242 = Var(within=Reals,bounds=(0,None),initialize=0.168127913963739)
m.x243 = Var(within=Reals,bounds=(0,None),initialize=0.168127913963739)
m.x244 = Var(within=Reals,bounds=(0,None),initialize=0.168127913963739)
m.x245 = Var(within=Reals,bounds=(0,None),initialize=0.19217735267196)
m.x246 = Var(within=Reals,bounds=(0,None),initialize=0.19217735267196)
m.x247 = Var(within=Reals,bounds=(0,None),initialize=0.19217735267196)
m.x248 = Var(within=Reals,bounds=(0,None),initialize=0.178983278137717)
m.x249 = Var(within=Reals,bounds=(0,None),initialize=0.178983278137717)
m.x250 = Var(within=Reals,bounds=(0,None),initialize=0.178983278137717)
m.x251 = Var(within=Reals,bounds=(0,None),initialize=0.178299040972272)
m.x252 = Var(within=Reals,bounds=(0,None),initialize=0.178299040972272)
m.x253 = Var(within=Reals,bounds=(0,None),initialize=0.178299040972272)
m.x254 = Var(within=Reals,bounds=(0,None),initialize=0.179237571892647)
m.x255 = Var(within=Reals,bounds=(0,None),initialize=0.179237571892647)
m.x256 = Var(within=Reals,bounds=(0,None),initialize=0.179237571892647)
...
m.c67 = Constraint(expr=m.x233*m.b201 + m.x233*m.x225 - m.x225*m.b201 <= 0)

m.c68 = Constraint(expr=m.x234*m.b202 + m.x234*m.x225 - m.x225*m.b202 <= 0)

m.c69 = Constraint(expr=m.x235*m.b203 + m.x235*m.x225 - m.x225*m.b203 <= 0)

m.c70 = Constraint(expr=m.x236*m.b204 + m.x236*m.x226 - m.x226*m.b204 <= 0)

m.c71 = Constraint(expr=m.x237*m.b205 + m.x237*m.x226 - m.x226*m.b205 <= 0)

m.c72 = Constraint(expr=m.x238*m.b206 + m.x238*m.x226 - m.x226*m.b206 <= 0)

m.c73 = Constraint(expr=m.x239*m.b207 + m.x239*m.x227 - m.x227*m.b207 <= 0)

m.c74 = Constraint(expr=m.x240*m.b208 + m.x240*m.x227 - m.x227*m.b208 <= 0)

m.c75 = Constraint(expr=m.x241*m.b209 + m.x241*m.x227 - m.x227*m.b209 <= 0)

m.c76 = Constraint(expr=m.x242*m.b210 + m.x242*m.x228 - m.x228*m.b210 <= 0)

m.c77 = Constraint(expr=m.x243*m.b211 + m.x243*m.x228 - m.x228*m.b211 <= 0)

m.c78 = Constraint(expr=m.x244*m.b212 + m.x244*m.x228 - m.x228*m.b212 <= 0)

m.c79 = Constraint(expr=m.x245*m.b213 + m.x245*m.x229 - m.x229*m.b213 <= 0)

m.c80 = Constraint(expr=m.x246*m.b214 + m.x246*m.x229 - m.x229*m.b214 <= 0)

m.c81 = Constraint(expr=m.x247*m.b215 + m.x247*m.x229 - m.x229*m.b215 <= 0)

m.c82 = Constraint(expr=m.x248*m.b216 + m.x248*m.x230 - m.x230*m.b216 <= 0)

m.c83 = Constraint(expr=m.x249*m.b217 + m.x249*m.x230 - m.x230*m.b217 <= 0)

m.c84 = Constraint(expr=m.x250*m.b218 + m.x250*m.x230 - m.x230*m.b218 <= 0)

m.c85 = Constraint(expr=m.x251*m.b219 + m.x251*m.x231 - m.x231*m.b219 <= 0)

m.c86 = Constraint(expr=m.x252*m.b220 + m.x252*m.x231 - m.x231*m.b220 <= 0)

m.c87 = Constraint(expr=m.x253*m.b221 + m.x253*m.x231 - m.x231*m.b221 <= 0)

m.c88 = Constraint(expr=m.x254*m.b222 + m.x254*m.x232 - m.x232*m.b222 <= 0)

m.c89 = Constraint(expr=m.x255*m.b223 + m.x255*m.x232 - m.x232*m.b223 <= 0)

m.c90 = Constraint(expr=m.x256*m.b224 + m.x256*m.x232 - m.x232*m.b224 <= 0)
