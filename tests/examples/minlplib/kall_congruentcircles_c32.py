...
m.x1 = Var(within=Reals,bounds=(0.25,5),initialize=0.25)
m.x2 = Var(within=Reals,bounds=(0.5,2),initialize=0.5)
m.x3 = Var(within=Reals,bounds=(0.5,1.5),initialize=0.5)
m.x4 = Var(within=Reals,bounds=(0.5,2),initialize=0.5)
m.x5 = Var(within=Reals,bounds=(0.5,1.5),initialize=0.5)
m.x6 = Var(within=Reals,bounds=(0.5,2),initialize=0.5)
m.x7 = Var(within=Reals,bounds=(0.5,1.5),initialize=0.5)
m.x8 = Var(within=Reals,bounds=(0,2.5),initialize=0)
...
m.c12 = Constraint(expr=   m.x2 <= 1.25)

m.c13 = Constraint(expr=   m.x3 <= 1)
