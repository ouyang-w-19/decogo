...
m.x13 = Var(within=Reals,bounds=(-8.94427190999916,8.94427190999916),initialize=0)
m.x14 = Var(within=Reals,bounds=(-8.94427190999916,8.94427190999916),initialize=0)
...
m.x29 = Var(within=Reals,bounds=(0.5,7.5),initialize=0.5)
m.x30 = Var(within=Reals,bounds=(0.5,3.5),initialize=0.5)
m.x31 = Var(within=Reals,bounds=(0,8),initialize=0)
m.x32 = Var(within=Reals,bounds=(0,4),initialize=0)
m.x33 = Var(within=Reals,bounds=(0,8),initialize=0)
m.x34 = Var(within=Reals,bounds=(0,4),initialize=0)
m.x35 = Var(within=Reals,bounds=(0,8),initialize=0)
m.x36 = Var(within=Reals,bounds=(0,4),initialize=0)
...
m.x43 = Var(within=Reals,bounds=(0,32),initialize=0)

m.obj = Objective(expr=m.x43, sense=minimize)

m.c1 = Constraint(expr= - m.x1 + m.x43 == -0.800398163397448)
...
m.c16 = Constraint(expr=   0.05*m.x2 + 0.075*m.x3 + m.x31 - m.x39 == 0)

m.c17 = Constraint(expr= - 0.05*m.x2 + 0.075*m.x3 + m.x33 - m.x39 == 0)

m.c18 = Constraint(expr= - 0.05*m.x2 - 0.075*m.x3 + m.x35 - m.x39 == 0)

m.c19 = Constraint(expr=   0.05*m.x2 - 0.075*m.x3 + m.x37 - m.x39 == 0)

m.c20 = Constraint(expr= - 0.075*m.x2 + 0.05*m.x3 + m.x32 - m.x40 == 0)

m.c21 = Constraint(expr= - 0.075*m.x2 - 0.05*m.x3 + m.x34 - m.x40 == 0)

m.c22 = Constraint(expr=   0.075*m.x2 - 0.05*m.x3 + m.x36 - m.x40 == 0)

m.c23 = Constraint(expr=   0.075*m.x2 + 0.05*m.x3 + m.x38 - m.x40 == 0)
...
m.c47 = Constraint(expr=   m.x29 <= 4)

m.c48 = Constraint(expr=   m.x30 <= 2)
