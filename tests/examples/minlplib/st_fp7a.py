...
m.obj = Objective(expr=2*m.x1 - 0.5*m.x1**2 - 0.5*m.x2**2 + 2*m.x2 - 0.5*m.x3**2 + 2*m.x3 - 0.5*m.x4**2 + 2*m.x4 - 0.5*
                       m.x5**2 + 2*m.x5 - 0.5*m.x6**2 + 2*m.x6 - 0.5*m.x7**2 + 2*m.x7 - 0.5*m.x8**2 + 2*m.x8 - 0.5*m.x9
                       **2 + 2*m.x9 - 0.5*m.x10**2 + 2*m.x10 - 0.5*m.x11**2 + 2*m.x11 - 0.5*m.x12**2 + 2*m.x12 - 0.5*
                       m.x13**2 + 2*m.x13 - 0.5*m.x14**2 + 2*m.x14 - 0.5*m.x15**2 + 2*m.x15 - 0.5*m.x16**2 + 2*m.x16 - 
                       0.5*m.x17**2 + 2*m.x17 - 0.5*m.x18**2 + 2*m.x18 - 0.5*m.x19**2 + 2*m.x19 - 0.5*m.x20**2 + 2*m.x20
                       , sense=minimize)
