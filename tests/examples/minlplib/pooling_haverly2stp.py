...
m.x2 = Var(within=Reals,bounds=(0,800),initialize=0)
m.x3 = Var(within=Reals,bounds=(0,800),initialize=0)
...
m.c2 = Constraint(expr=   m.x12 + m.x13 <= 800)

m.c3 = Constraint(expr=   m.x14 + m.x15 <= 800)

m.c4 = Constraint(expr=   m.x4 + m.x5 <= 800)

m.c5 = Constraint(expr=   m.x12 + m.x13 + m.x14 + m.x15 <= 800)

m.c6 = Constraint(expr=   m.x4 + m.x12 + m.x14 <= 600)
