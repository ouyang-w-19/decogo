...
m.x1 = Var(within=Reals,bounds=(0.49,15.2),initialize=0.49)
...
m.x15 = Var(within=Reals,bounds=(0.5,1.4),initialize=0.5)
m.x16 = Var(within=Reals,bounds=(0.7,7.3),initialize=0.7)
m.x17 = Var(within=Reals,bounds=(0.7,1.2),initialize=0.7)
m.x18 = Var(within=Reals,bounds=(0,8),initialize=0)
m.x19 = Var(within=Reals,bounds=(0,1.9),initialize=0)
m.x20 = Var(within=Reals,bounds=(0,15.2),initialize=0)

m.obj = Objective(expr=m.x20, sense=minimize)

m.c1 = Constraint(expr= - m.x1 + m.x20 == -7.03716754404114)
...
m.c9 = Constraint(expr=(m.x2 - m.x16)*(m.x2 - m.x16) + (m.x3 - m.x17)*(m.x3 - m.x17) >= 1.44)
...
m.c14 = Constraint(expr=(m.x4 - m.x14)*(m.x4 - m.x14) + (m.x5 - m.x15)*(m.x5 - m.x15) >= 1)

m.c15 = Constraint(expr=(m.x4 - m.x16)*(m.x4 - m.x16) + (m.x5 - m.x17)*(m.x5 - m.x17) >= 1.44)
...
m.c19 = Constraint(expr=(m.x6 - m.x14)*(m.x6 - m.x14) + (m.x7 - m.x15)*(m.x7 - m.x15) >= 1)

m.c20 = Constraint(expr=(m.x6 - m.x16)*(m.x6 - m.x16) + (m.x7 - m.x17)*(m.x7 - m.x17) >= 1.44)
...
m.c23 = Constraint(expr=(m.x8 - m.x14)*(m.x8 - m.x14) + (m.x9 - m.x15)*(m.x9 - m.x15) >= 1)

m.c24 = Constraint(expr=(m.x8 - m.x16)*(m.x8 - m.x16) + (m.x9 - m.x17)*(m.x9 - m.x17) >= 1.44)

m.c25 = Constraint(expr=(m.x10 - m.x12)*(m.x10 - m.x12) + (m.x11 - m.x13)*(m.x11 - m.x13) >= 1)

m.c26 = Constraint(expr=(m.x10 - m.x14)*(m.x10 - m.x14) + (m.x11 - m.x15)*(m.x11 - m.x15) >= 1)

m.c27 = Constraint(expr=(m.x10 - m.x16)*(m.x10 - m.x16) + (m.x11 - m.x17)*(m.x11 - m.x17) >= 1.44)

m.c28 = Constraint(expr=(m.x12 - m.x14)*(m.x12 - m.x14) + (m.x13 - m.x15)*(m.x13 - m.x15) >= 1)

m.c29 = Constraint(expr=(m.x12 - m.x16)*(m.x12 - m.x16) + (m.x13 - m.x17)*(m.x13 - m.x17) >= 1.44)

m.c30 = Constraint(expr=(m.x14 - m.x16)*(m.x14 - m.x16) + (m.x15 - m.x17)*(m.x15 - m.x17) >= 1.44)
...
m.c43 = Constraint(expr=   m.x14 - m.x18 <= -0.5)

m.c44 = Constraint(expr=   m.x15 - m.x19 <= -0.5)

m.c45 = Constraint(expr=   m.x16 - m.x18 <= -0.7)

m.c46 = Constraint(expr=   m.x17 - m.x19 <= -0.7)

m.c47 = Constraint(expr=   m.x2 <= 4)

m.c48 = Constraint(expr=   m.x3 <= 0.95)
...
m.c54 = Constraint(expr=   m.x2 - m.x14 <= 0)

m.c55 = Constraint(expr=   m.x4 - m.x6 <= 0)

m.c56 = Constraint(expr=   m.x4 - m.x8 <= 0)

m.c57 = Constraint(expr=   m.x4 - m.x10 <= 0)

m.c58 = Constraint(expr=   m.x4 - m.x12 <= 0)

m.c59 = Constraint(expr=   m.x4 - m.x14 <= 0)

m.c60 = Constraint(expr=   m.x6 - m.x8 <= 0)

m.c61 = Constraint(expr=   m.x6 - m.x10 <= 0)

m.c62 = Constraint(expr=   m.x6 - m.x12 <= 0)

m.c63 = Constraint(expr=   m.x6 - m.x14 <= 0)

m.c64 = Constraint(expr=   m.x8 - m.x10 <= 0)

m.c65 = Constraint(expr=   m.x8 - m.x12 <= 0)

m.c66 = Constraint(expr=   m.x8 - m.x14 <= 0)

m.c67 = Constraint(expr=   m.x10 - m.x12 <= 0)

m.c68 = Constraint(expr=   m.x10 - m.x14 <= 0)

m.c69 = Constraint(expr=   m.x12 - m.x14 <= 0)
