...
m.x12 = Var(within=Reals,bounds=(0.5,3.5),initialize=0.5)
m.x13 = Var(within=Reals,bounds=(0.5,1.5),initialize=0.5)
m.x14 = Var(within=Reals,bounds=(0,4),initialize=0)
...
m.c30 = Constraint(expr=   m.x2 <= 2)

m.c31 = Constraint(expr=   m.x3 <= 1)
