...
m.x113 = Var(within=Reals,bounds=(0,None),initialize=1.84609632242111)
m.x114 = Var(within=Reals,bounds=(0,None),initialize=2.47900149079549)
m.x115 = Var(within=Reals,bounds=(0,None),initialize=2.30645349772837)
m.x116 = Var(within=Reals,bounds=(0,None),initialize=3.29868478857466)
m.x117 = Var(within=Reals,bounds=(0,None),initialize=0.216213849109492)
m.x118 = Var(within=Reals,bounds=(0,None),initialize=0.216213849109492)
m.x119 = Var(within=Reals,bounds=(0,None),initialize=0.216213849109492)
m.x120 = Var(within=Reals,bounds=(0,None),initialize=0.237520401313832)
m.x121 = Var(within=Reals,bounds=(0,None),initialize=0.237520401313832)
m.x122 = Var(within=Reals,bounds=(0,None),initialize=0.237520401313832)
m.x123 = Var(within=Reals,bounds=(0,None),initialize=0.232520382671138)
m.x124 = Var(within=Reals,bounds=(0,None),initialize=0.232520382671138)
m.x125 = Var(within=Reals,bounds=(0,None),initialize=0.232520382671138)
m.x126 = Var(within=Reals,bounds=(0,None),initialize=0.255790235914493)
m.x127 = Var(within=Reals,bounds=(0,None),initialize=0.255790235914493)
m.x128 = Var(within=Reals,bounds=(0,None),initialize=0.255790235914493)
...
m.c47 = Constraint(expr=m.x117*m.b101 + m.x117*m.x113 - m.x113*m.b101 <= 0)

m.c48 = Constraint(expr=m.x118*m.b102 + m.x118*m.x113 - m.x113*m.b102 <= 0)

m.c49 = Constraint(expr=m.x119*m.b103 + m.x119*m.x113 - m.x113*m.b103 <= 0)

m.c50 = Constraint(expr=m.x120*m.b104 + m.x120*m.x114 - m.x114*m.b104 <= 0)

m.c51 = Constraint(expr=m.x121*m.b105 + m.x121*m.x114 - m.x114*m.b105 <= 0)

m.c52 = Constraint(expr=m.x122*m.b106 + m.x122*m.x114 - m.x114*m.b106 <= 0)

m.c53 = Constraint(expr=m.x123*m.b107 + m.x123*m.x115 - m.x115*m.b107 <= 0)

m.c54 = Constraint(expr=m.x124*m.b108 + m.x124*m.x115 - m.x115*m.b108 <= 0)

m.c55 = Constraint(expr=m.x125*m.b109 + m.x125*m.x115 - m.x115*m.b109 <= 0)

m.c56 = Constraint(expr=m.x126*m.b110 + m.x126*m.x116 - m.x116*m.b110 <= 0)

m.c57 = Constraint(expr=m.x127*m.b111 + m.x127*m.x116 - m.x116*m.b111 <= 0)

m.c58 = Constraint(expr=m.x128*m.b112 + m.x128*m.x116 - m.x116*m.b112 <= 0)
