...
m.c97 = Constraint(expr=   m.x1 - 2*m.b85 <= 0)

m.c98 = Constraint(expr=   m.x2 - 2*m.b86 <= 0)

m.c99 = Constraint(expr=   m.x3 - 2*m.b87 <= 0)

m.c100 = Constraint(expr=   m.x4 - 2*m.b88 <= 0)

m.c101 = Constraint(expr=   m.x5 - 2*m.b89 <= 0)

m.c102 = Constraint(expr=   m.x6 - 2*m.b90 <= 0)

m.c103 = Constraint(expr=   m.x7 - 2*m.b91 <= 0)

m.c104 = Constraint(expr=   m.x8 - 2*m.b92 <= 0)

m.c105 = Constraint(expr=   m.x9 - 2*m.b93 <= 0)

m.c106 = Constraint(expr=   m.x10 - 2*m.b94 <= 0)

m.c107 = Constraint(expr=   m.x11 - 2*m.b95 <= 0)

m.c108 = Constraint(expr=   m.x12 - 2*m.b96 <= 0)

m.c109 = Constraint(expr=   m.x13 - 2*m.b97 <= 0)

m.c110 = Constraint(expr=   m.x14 - 2*m.b98 <= 0)

m.c111 = Constraint(expr=   m.x15 - 2*m.b85 <= 0)

m.c112 = Constraint(expr=   m.x16 - 2*m.b86 <= 0)

m.c113 = Constraint(expr=   m.x17 - 2*m.b87 <= 0)

m.c114 = Constraint(expr=   m.x18 - 2*m.b88 <= 0)

m.c115 = Constraint(expr=   m.x19 - 2*m.b89 <= 0)

m.c116 = Constraint(expr=   m.x20 - 2*m.b90 <= 0)

m.c117 = Constraint(expr=   m.x21 - 2*m.b91 <= 0)

m.c118 = Constraint(expr=   m.x22 - 2*m.b92 <= 0)

m.c119 = Constraint(expr=   m.x23 - 2*m.b93 <= 0)

m.c120 = Constraint(expr=   m.x24 - 2*m.b94 <= 0)

m.c121 = Constraint(expr=   m.x25 - 2*m.b95 <= 0)

m.c122 = Constraint(expr=   m.x26 - 2*m.b96 <= 0)

m.c123 = Constraint(expr=   m.x27 - 2*m.b97 <= 0)

m.c124 = Constraint(expr=   m.x28 - 2*m.b98 <= 0)

m.c125 = Constraint(expr= - m.b85 + m.s1s99 + m.s1s100 + m.s1s101 + m.s1s102 + m.s1s103 + m.s1s104 + m.s1s105 == 0)

m.c126 = Constraint(expr= - m.b86 + m.s1s106 + m.s1s107 + m.s1s108 + m.s1s109 + m.s1s110 + m.s1s111 + m.s1s112 == 0)

m.c127 = Constraint(expr= - m.b87 + m.s1s113 + m.s1s114 + m.s1s115 + m.s1s116 + m.s1s117 + m.s1s118 + m.s1s119 == 0)

m.c128 = Constraint(expr= - m.b88 + m.s1s120 + m.s1s121 + m.s1s122 + m.s1s123 + m.s1s124 + m.s1s125 + m.s1s126 == 0)

m.c129 = Constraint(expr= - m.b89 + m.s1s127 + m.s1s128 + m.s1s129 + m.s1s130 + m.s1s131 + m.s1s132 + m.s1s133 == 0)

m.c130 = Constraint(expr= - m.b90 + m.s1s134 + m.s1s135 + m.s1s136 + m.s1s137 + m.s1s138 + m.s1s139 + m.s1s140 == 0)

m.c131 = Constraint(expr= - m.b91 + m.s1s141 + m.s1s142 + m.s1s143 + m.s1s144 + m.s1s145 + m.s1s146 + m.s1s147 == 0)

m.c132 = Constraint(expr= - m.b92 + m.s1s148 + m.s1s149 + m.s1s150 + m.s1s151 + m.s1s152 + m.s1s153 + m.s1s154 == 0)

m.c133 = Constraint(expr= - m.b93 + m.s1s155 + m.s1s156 + m.s1s157 + m.s1s158 + m.s1s159 + m.s1s160 + m.s1s161 == 0)

m.c134 = Constraint(expr= - m.b94 + m.s1s162 + m.s1s163 + m.s1s164 + m.s1s165 + m.s1s166 + m.s1s167 + m.s1s168 == 0)

m.c135 = Constraint(expr= - m.b95 + m.s1s169 + m.s1s170 + m.s1s171 + m.s1s172 + m.s1s173 + m.s1s174 + m.s1s175 == 0)

m.c136 = Constraint(expr= - m.b96 + m.s1s176 + m.s1s177 + m.s1s178 + m.s1s179 + m.s1s180 + m.s1s181 + m.s1s182 == 0)

m.c137 = Constraint(expr= - m.b97 + m.s1s183 + m.s1s184 + m.s1s185 + m.s1s186 + m.s1s187 + m.s1s188 + m.s1s189 == 0)

m.c138 = Constraint(expr= - m.b98 + m.s1s190 + m.s1s191 + m.s1s192 + m.s1s193 + m.s1s194 + m.s1s195 + m.s1s196 == 0)
