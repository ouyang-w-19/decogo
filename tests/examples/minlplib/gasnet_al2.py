#  MINLP written by GAMS Convert at 04/21/18 13:52:15
#  
#  Equation counts
#      Total        E        G        L        N        X        C        B
...
m.x264 = Var(within=Reals,bounds=(1.06,1.06),initialize=1.06)
m.x265 = Var(within=Reals,bounds=(1.06,1.06),initialize=1.06)
m.x266 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x267 = Var(within=Reals,bounds=(1.06,1.06),initialize=1.06)
m.x268 = Var(within=Reals,bounds=(1.2,1.2),initialize=1.2)
m.x269 = Var(within=Reals,bounds=(1.06,1.06),initialize=1.06)
...
m.x276 = Var(within=Reals,bounds=(1.06,1.06),initialize=1.06)
...
m.x281 = Var(within=Reals,bounds=(0.92,0.92),initialize=0.92)
m.x282 = Var(within=Reals,bounds=(0.92,0.92),initialize=0.92)
m.x283 = Var(within=Reals,bounds=(0.92,0.92),initialize=0.92)
m.x284 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x285 = Var(within=Reals,bounds=(0.92,0.92),initialize=0.92)
...
m.x290 = Var(within=Reals,bounds=(1.007,1.007),initialize=1.007)
m.x291 = Var(within=Reals,bounds=(1.007,1.007),initialize=1.007)
m.x292 = Var(within=Reals,bounds=(0,None),initialize=0)
m.x293 = Var(within=Reals,bounds=(30,30),initialize=30)
m.x294 = Var(within=Reals,bounds=(1.008,1.008),initialize=1.008)
m.x295 = Var(within=Reals,bounds=(1.008,1.008),initialize=1.008)
m.x296 = Var(within=Reals,bounds=(1.008,1.008),initialize=1.008)
...
m.x541 = Var(within=Reals,bounds=(20.88,20.88),initialize=20.88)
m.x542 = Var(within=Reals,bounds=(20.88,20.88),initialize=20.88)
m.x543 = Var(within=Reals,bounds=(17.05,17.05),initialize=17.05)
m.x544 = Var(within=Reals,bounds=(20.88,20.88),initialize=20.88)
m.x545 = Var(within=Reals,bounds=(17.05,17.05),initialize=17.05)
m.x546 = Var(within=Reals,bounds=(20.88,20.88),initialize=20.88)
m.x547 = Var(within=Reals,bounds=(17.05,17.05),initialize=17.05)
m.x548 = Var(within=Reals,bounds=(17.05,17.05),initialize=17.05)
m.x549 = Var(within=Reals,bounds=(17.05,17.05),initialize=17.05)
m.x550 = Var(within=Reals,bounds=(17.05,17.05),initialize=17.05)
m.x551 = Var(within=Reals,bounds=(17.05,17.05),initialize=17.05)
m.x552 = Var(within=Reals,bounds=(17.05,17.05),initialize=17.05)
m.x553 = Var(within=Reals,bounds=(20.88,20.88),initialize=20.88)
m.x554 = Var(within=Reals,bounds=(17.05,17.05),initialize=17.05)
m.x555 = Var(within=Reals,bounds=(17.05,17.05),initialize=17.05)
m.x556 = Var(within=Reals,bounds=(17.05,17.05),initialize=17.05)
m.x557 = Var(within=Reals,bounds=(17.05,17.05),initialize=17.05)
m.x558 = Var(within=Reals,bounds=(18.85,18.85),initialize=18.85)
m.x559 = Var(within=Reals,bounds=(18.85,18.85),initialize=18.85)
m.x560 = Var(within=Reals,bounds=(18.85,18.85),initialize=18.85)
m.x561 = Var(within=Reals,bounds=(16.07,16.07),initialize=16.07)
m.x562 = Var(within=Reals,bounds=(18.85,18.85),initialize=18.85)
m.x563 = Var(within=Reals,bounds=(16.07,16.07),initialize=16.07)
m.x564 = Var(within=Reals,bounds=(16.07,16.07),initialize=16.07)
m.x565 = Var(within=Reals,bounds=(16.07,16.07),initialize=16.07)
m.x566 = Var(within=Reals,bounds=(16.07,16.07),initialize=16.07)
m.x567 = Var(within=Reals,bounds=(18.93,18.93),initialize=18.93)
m.x568 = Var(within=Reals,bounds=(18.93,18.93),initialize=18.93)
m.x569 = Var(within=Reals,bounds=(15.24,15.24),initialize=15.24)
m.x570 = Var(within=Reals,bounds=(15.24,15.24),initialize=15.24)
m.x571 = Var(within=Reals,bounds=(19.19,19.19),initialize=19.19)
m.x572 = Var(within=Reals,bounds=(19.19,19.19),initialize=19.19)
m.x573 = Var(within=Reals,bounds=(19.19,19.19),initialize=19.19)
m.x574 = Var(within=Reals,bounds=(14.43,14.43),initialize=14.43)
m.x575 = Var(within=Reals,bounds=(14.43,14.43),initialize=14.43)
m.x576 = Var(within=Reals,bounds=(14.43,14.43),initialize=14.43)
m.x577 = Var(within=Reals,bounds=(14.43,14.43),initialize=14.43)
m.x578 = Var(within=Reals,bounds=(14.43,14.43),initialize=14.43)
m.x579 = Var(within=Reals,bounds=(14.43,14.43),initialize=14.43)
m.x580 = Var(within=Reals,bounds=(14.43,14.43),initialize=14.43)
m.x581 = Var(within=Reals,bounds=(14.43,14.43),initialize=14.43)
m.x582 = Var(within=Reals,bounds=(14.43,14.43),initialize=14.43)
...
m.c66 = Constraint(expr=0.043*m.x4*m.b715 - m.x8 == 0)

m.c67 = Constraint(expr=0.068*m.x5*m.b716 - m.x9 == 0)

m.c68 = Constraint(expr=0.067*m.x6*m.b717 - m.x10 == 0)

m.c69 = Constraint(expr=0.052*m.x7*m.b718 - m.x11 == 0)
...
m.c236 = Constraint(expr=-((0.6743812 + 0.2689483368*m.x106 - 0.061124844*(1.56*m.x106)**3 - 0.212305*m.x264 + 0.012517*
                         m.x336 + 0.001813*m.x541)*m.b597 - 0.1*m.b597) + m.x499 == 0.1)

m.c237 = Constraint(expr=-((0.4410363233 + 0.674422164*m.x107 - 0.375472557*(1.56*m.x107)**2 - 0.492375904*m.x265 + 
                         0.147206587*m.x337 + 0.0022176*m.x542)*m.b598 - 0.1*m.b598) + m.x500 == 0.1)

m.c238 = Constraint(expr=   m.x502 - 0.44*m.b600 == 0.1)

m.c239 = Constraint(expr=-((0.40599928065 + 0.453411504*m.x111 - 0.0557838182809601*(1.56*m.x111)**4 - 0.096251353*
                         m.x269 + 0.014483225*m.x341 + 0.001534204*m.x546)*m.b602 - 0.1*m.b602) + m.x504 == 0.1)

m.c240 = Constraint(expr=   m.x511 - 0.438*m.b609 == 0.1)

m.c241 = Constraint(expr=-((0.31006438 + 1.253062044*m.x123 - 0.52878395025*(1.56*m.x123)**2 - 0.24863*m.x281 + 0.069876
                         *m.x353)*m.b614 - 0.1*m.b614) + m.x516 == 0.1)

m.c242 = Constraint(expr=-((1.00479079007 + 0.06515262*m.x124 - 0.03196688625*(1.56*m.x124)**3 - 0.25001943*m.x282 - 
...
m.c245 = Constraint(expr=-((0.497320008 + 0.665189928*m.x132 - 0.08968834512*(1.56*m.x132)**5 - 0.282888*m.x290 + 
                         0.018042*m.x362)*m.b623 - 0.1*m.b623) + m.x525 == 0.1)

m.c246 = Constraint(expr=-((0.95958212 + 0.590344092*m.x133 - 0.0670442346*(1.56*m.x133)**5 - 0.71085*m.x291 + 0.019723*
                         m.x363)*m.b624 - 0.1*m.b624) + m.x526 == 0.1)

m.c247 = Constraint(expr=-((0.37444155 + 1.391185224*m.x136 - 0.4689234*(1.56*m.x136)**2 - 0.2834*m.x294 + 0.02921*
                         m.x366)*m.b627 - 0.1*m.b627) + m.x529 == 0.1)

m.c248 = Constraint(expr=-((0.365481092 + 0.2276703*m.x137 - 0.893353890000001*(1.56*m.x137)**2 - 0.43301*m.x295 + 
                         0.01956*m.x367)*m.b628 - 0.1*m.b628) + m.x530 == 0.1)

m.c249 = Constraint(expr=-((0.408631203 + 0.94669536*m.x138 - 0.2513976*(1.56*m.x138)**2 - 0.341281*m.x296 + 0.0318298*
                         m.x368)*m.b629 - 0.1*m.b629) + m.x531 == 0.1)

m.c250 = Constraint(expr=-((0.35341312145 + 0.29530827456*m.x108 - 0.02964*m.x266 + 0.0080054*m.x338 + 0.0015436*m.x543)
                         *m.b599 - 0.1*m.b599) + m.x501 == 0.1)

m.c251 = Constraint(expr=   m.x503 - 0.44*m.b601 == 0.1)

m.c252 = Constraint(expr=-((0.5540774312 + 0.130967928*m.x112 - 0.192731*m.x270 + 0.00266634*m.x342 + 0.00162897*m.x547)
                         *m.b603 - 0.1*m.b603) + m.x505 == 0.1)

m.c253 = Constraint(expr=-((0.5222713672 + 0.0023832861*m.x113 - 0.054453323*m.x271 - 0.00105772*m.x343 + 0.0012907546*
                         m.x548)*m.b604 - 0.1*m.b604) + m.x506 == 0.1)

m.c254 = Constraint(expr=-((0.5338395884 + 0.00260759538*m.x115 - 0.054453323*m.x273 - 0.00105772*m.x345 + 0.001296499*
                         m.x550)*m.b606 - 0.1*m.b606) + m.x508 == 0.1)

m.c255 = Constraint(expr=-((0.2138953614 + 0.00274778868*m.x116 - 0.054453323*m.x274 - 0.00105772*m.x346)*m.b607 - 0.1*
                         m.b607) + m.x509 == 0.1)

m.c256 = Constraint(expr=   m.x510 - 0.438*m.b608 == 0.1)

m.c257 = Constraint(expr=-((0.691563515 + 0.1383891912*m.x126 - 0.026399*m.x284 + 0.001522597*m.x356 + 0.001434255*
                         m.x561)*m.b617 - 0.1*m.b617) + m.x519 == 0.1)

m.c258 = Constraint(expr=-((-0.0605557606111601 + 0.866247954*m.x128 - 0.088058278325*(1.56*m.x128)**4 - 0.299918778*
                         m.x286 + 0.047657457*m.x358 + 0.002911323*m.x563)*m.b619 - 0.1*m.b619) + m.x521 == 0.1)

m.c259 = Constraint(expr=-((0.75755228832 + 2.919624496875e-14*(1.56*m.x129)**4 - 0.566610876*m.x129 + 0.117547132*
                         m.x287 - 0.002693371*m.x359 - 0.000420452*m.x564)*m.b620 - 0.1*m.b620) + m.x522 == 0.1)

m.c260 = Constraint(expr=-((0.75755228832 + 2.919624496875e-14*(1.56*m.x130)**4 - 0.566610876*m.x130 + 0.117547132*
                         m.x288 - 0.002693371*m.x360 - 0.000420452*m.x565)*m.b621 - 0.1*m.b621) + m.x523 == 0.1)

m.c261 = Constraint(expr=-((0.39169609698 + 0.31992012*m.x131 - 0.05045617*m.x289 - 0.000762165*m.x361 + 0.001691501*
                         m.x566)*m.b622 - 0.1*m.b622) + m.x524 == 0.1)

m.c262 = Constraint(expr=-((0.598906092 + 2.3506704*m.x134 - 0.8893753344*(1.56*m.x134)**6 - 0.17814*m.x292 + 0.00465*
                         m.x364)*m.b625 - 0.1*m.b625) + m.x527 == 0.1)

m.c263 = Constraint(expr=-((0.56462577072 + 0.47669076*m.x135 - 0.016401*m.x293 + 0.0054329*m.x365)*m.b626 - 0.1*m.b626)
                          + m.x528 == 0.1)

m.c264 = Constraint(expr=-((0.52608584421 + 0.002230320825*(1.56*m.x139)**2 + 0.0869268348*m.x139 - 0.274154109*m.x297
                          + 0.078276052*m.x369 + 0.001891106*m.x574)*m.b630 - 0.1*m.b630) + m.x532 == 0.1)

m.c265 = Constraint(expr=-((0.4870775544 + 0.766238226*m.x140 - 0.678019327*m.x298 + 0.092680354*m.x370 + 0.00219434*
                         m.x575)*m.b631 - 0.1*m.b631) + m.x533 == 0.1)

m.c266 = Constraint(expr=-((0.64565222694 + 0.193437738*m.x141 - 0.00803113140598437*(1.56*m.x141)**6 - 0.1307114*m.x299
                          + 0.000866168*m.x371)*m.b632 - 0.1*m.b632) + m.x534 == 0.1)

m.c267 = Constraint(expr=-((0.9797369278 + 0.044811088*(1.56*m.x142)**2 - 0.1855076496*m.x142 - 0.36306144*m.x300 + 
                         0.001237837*m.x372 + 0.001130157*m.x577)*m.b633 - 0.1*m.b633) + m.x535 == 0.1)

m.c268 = Constraint(expr=-((0.047581568 + 1.7104449024*m.x143 - 0.5534562816*(1.56*m.x143)**2 - 0.0028879*m.x301 - 
                         0.00300198*m.x373)*m.b634 - 0.1*m.b634) + m.x536 == 0.1)

m.c269 = Constraint(expr=-((0.55136753608 + 0.000801504*(1.56*m.x145)**2 + 0.3665376*m.x145 - 0.197132*m.x303 - 
                         0.00132275*m.x375 + 0.001978287*m.x580)*m.b636 - 0.1*m.b636) + m.x538 == 0.1)

m.c270 = Constraint(expr=-((0.5153654191 + 0.36010095264*m.x146 - 0.028899237312*(1.56*m.x146)**2 - 0.156696216*m.x304
                          + 0.000267625*m.x376 + 0.002035819*m.x581)*m.b637 - 0.1*m.b637) + m.x539 == 0.1)

m.c271 = Constraint(expr=-((0.155565403844 + 2.507932752*m.x147 - 0.479644052*(1.56*m.x147)**2 - 0.038886756*m.x305 + 
                         0.005576144*m.x377 + 0.002312085*m.x582)*m.b638 - 0.1*m.b638) + m.x540 == 0.1)

m.c272 = Constraint(expr=-((0.5288395884 + 0.00260759538*m.x114 - 0.054453323*m.x272 - 0.00105772*m.x344 + 0.001296499*
                         m.x549)*m.b605 - 0.1*m.b605) + m.x507 == 0.1)

m.c273 = Constraint(expr=-0.49658712171*log(43/(1.013 + m.x306))*m.x148 + 2.13*m.x466 == 0)

m.c274 = Constraint(expr=-0.2991488685*log(43/(1.013 + m.x307))*m.x149 + 2.13*m.x467 == 0)

m.c275 = Constraint(expr=-0.494909288994*log(43/(1.013 + m.x308))*m.x150 + 2.13*m.x468 == 0)

m.c276 = Constraint(expr=-0.493488267408*log(43/(1.013 + m.x309))*m.x151 + 2.13*m.x469 == 0)

m.c277 = Constraint(expr=-0.2964466791*log(43/(1.013 + m.x310))*m.x152 + 2.13*m.x470 == 0)

m.c278 = Constraint(expr=-0.571374338835*log(5.01083333333333 + 0.833333333333333*m.x311)*m.x158 + 1.13*m.x471 == 0)

m.c279 = Constraint(expr=-0.2991488685*log(5.01083333333333 + 0.833333333333333*m.x311)*m.x159 + 1.13*m.x472 == 0)

m.c280 = Constraint(expr=-(1.99123890324335*m.x161*m.b626 + 5678.08789608*log(5.01083333333333 + 0.833333333333333*
                         m.x324)*m.x161*(0.0001 - 0.0001*m.b626)) + 1.13*m.x474 == 0)

m.c281 = Constraint(expr=-0.569443820469*log(5.01083333333333 + 0.833333333333333*m.x320)*m.x160 + 1.13*m.x473 == 0)

m.c282 = Constraint(expr= - 10.3288876033497*m.x168 + 1.313*m.x475 == 0)

m.c283 = Constraint(expr= - 5.67521296887348*m.x169 + 1.313*m.x476 == 0)

m.c284 = Constraint(expr= - 5.65603796901313*m.x170 + 1.313*m.x477 == 0)

m.c285 = Constraint(expr= - 5.63979791811099*m.x171 + 1.313*m.x478 == 0)

m.c286 = Constraint(expr= - 5.62394919373662*m.x172 + 1.313*m.x479 == 0)
...
m.c667 = Constraint(expr= - 1.65189363416599*m.x174 - 1.65189363416599*m.x195 == -29008.8638195004)

m.c668 = Constraint(expr= - 84306.3693462041*m.x2 - 0.843063693462041*m.x3 + 0.843063693462041*m.x20
                          - 1.72828057159718*m.x175 == -52185.6426253003)

m.c669 = Constraint(expr= - 85898.1076646882*m.x21 - 1.76091120712611*m.x191 == -4982.09024455191)

m.c670 = Constraint(expr=   0.551116009920088*m.x3 + 55111.6009920088*m.x21 - 1.12978782033618*m.x176
                          - 1.12978782033618*m.x192 == -10140.5345825296)

m.c671 = Constraint(expr= - 1.79008033531261*m.x182 == -11962.9758994062)

m.c672 = Constraint(expr=   58298.8398530869*m.x2 - 1.19512621698828*m.x186 == -1574.06867603335)

m.c673 = Constraint(expr= - 1.1861984365326*m.x183 - 1.1861984365326*m.x187 + 57863.3383674438*m.x252
                          == -3529.66364041407)

m.c674 = Constraint(expr= - 1.76244630986729*m.x188 == -8081.46112817197)

m.c675 = Constraint(expr= - 0.861148427542971*m.x20 - 1.76535427646309*m.x177 == -6975.30226309807)

m.c676 = Constraint(expr= - 0.28527097263486*m.x184 == -1488.97532058195)

m.c677 = Constraint(expr= - 1.7633953532382*m.x185 - 1.7633953532382*m.x189 == -10356.7219770673)

m.c678 = Constraint(expr= - 1.27042754534807*m.x190 == -6569.03999058025)

m.c679 = Constraint(expr= - 16.2247724574594*m.x178 - 16.2247724574594*m.x196 == -291697.665215671)

m.c680 = Constraint(expr= - 81300.8130081301*m.x1 + 8.13008130081301*m.x19 - 16.6666666666667*m.x179
                          - 16.6666666666667*m.x197 == -261065.040650407)
...
m.c683 = Constraint(expr= - 0.866926744690074*m.x18 - 1.77719982661465*m.x194 == -15604.6814044213)
